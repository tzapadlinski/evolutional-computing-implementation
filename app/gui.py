...
class GeneticAlgorithmGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Label(input_frame, text="Uniform Crossover Probability:", font=("Helvetica", 11)).grid(row=10, column=0, padx=5, pady=5, sticky="w")
        self.uniform_crossover_prob_entry = ttk.Entry(input_frame, font=("Helvetica", 11), width=25)
        self.uniform_crossover_prob_entry.grid(row=10, column=1, padx=5, pady=5)

        ttk.Label(input_frame, text="Cross Method:", font=("Helvetica", 11)).grid(row=11, column=0, padx=5, pady=5, sticky="w")
        ...
        self.cross_method_dropdown.grid(row=11, column=1, padx=5, pady=5)

        ttk.Label(input_frame, text="Mutation Method:", font=("Helvetica", 11)).grid(row=12, column=0, padx=5, pady=5, sticky="w")
        ...
        self.mutation_method_dropdown.grid(row=12, column=1, padx=5, pady=5)

        available_functions = Function.get_available_functions()
        ttk.Label(input_frame, text="Function to Optimize:", font=("Helvetica", 11)).grid(row=13, column=0, padx=5, pady=5, sticky="w")
        ...
        self.function_dropdown.grid(row=13, column=1, padx=5, pady=5)

        ttk.Label(input_frame, text="Optimization Mode:", font=("Helvetica", 11)).grid(row=14, column=0, padx=5, pady=5, sticky="w")
        ...
        self.optimization_mode_dropdown.grid(row=14, column=1, padx=5, pady=5)
    ...
    def run_algorithm(self):
        ...
        self.output_text.insert(tk.END, f"Selection Method: {selection_method}\n"
